...
class BTNonLeafNode {
  public:
    static const int NL_FIRST_KEY = sizeof(PageId);
    static const int NL_MAX_KEYS = (PageFile::PAGE_SIZE - sizeof(PageId)) / (sizeof(int) + sizeof(PageId));
    ...
    */
    ...
    static void convertToChar(int conv, char* buffer, int index);

    static void convertToInt(char* buffer, int index, int& result);
